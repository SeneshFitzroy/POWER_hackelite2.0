...
const SetupComponent = () => {
  ...
  const sampleDataInfo = [
    ...
    },
    {
      ...
      description: 'No sample data - add employees manually',
      items: ['Use Employee Management to add staff', 'Configure roles and permissions']
    },
    {
      icon: <Assignment />,
      title: 'Patient Records',
      description: 'No sample patients - add via patient registration',
      items: ['Patient records will appear after registration', 'Medical history tracked automatically']
    },
    {
      icon: <Storage />,
      title: 'Pharmacy Registration',
      description: 'Configure pharmacy license information',
      items: ['Enter your registration number', 'Upload license documents']
    }
  ];
