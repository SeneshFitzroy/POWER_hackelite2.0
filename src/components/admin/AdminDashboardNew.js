      ...
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 rounded-xl p-8 text-white shadow-2xl">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 text-lg">Manage your ERP system with complete control</p>
          </div>
          <div className="text-right">
            <div className="text-blue-100 text-sm">System Status</div>
            <div className={`text-xl font-bold ${stats.systemHealth === 'Good' ? 'text-green-300' : 'text-yellow-300'}`}>
              {stats.systemHealth}
            </div>
          </div>
        </div>
