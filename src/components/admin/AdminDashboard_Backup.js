...
const AdminDashboard = () => {
  ...
  const handleLogout = () => {
    console.log('Admin Backup Logout initiated - Enhanced logout system');
    ...
    console.log('Admin Backup logout: All dashboard flags set');
          ...
          <Paper sx={{ p: 3, borderRadius: '16px', minHeight: '300px' }}>
            ...
            <Box display="flex" flexDirection="column" gap={2.5} mt={2}>
              ...
              <Box>
                ...
                <Typography variant="h5" fontWeight="bold" color="success.main">{formatLKR(adminStats.avgOrderValue)}</Typography>
              ...
              {topProducts.map((product, index) => (
                <ListItem key={product.id} divider={index < topProducts.length - 1}>
                  <ListItemText
                    ...
                    secondary={`${product.sales} sales • ${formatLKR(product.revenue)} revenue`}
                  />
                  <Chip 
